            ...
            with open(file_path,'r',encoding='utf-8') as f:
                ...
                if sec_key is None:
                    ...
                    if key in extract_data:
                        return extract_data[key].get(sec_key) #get()方法获取sec_key对应的值，如果不存在则返回None
                    return None
...
if __name__ == '__main__':
    # data = get_yaml_data('test_cases/login/logins.yaml')
